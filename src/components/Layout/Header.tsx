...
import { Compass, Leaf, Users, Wifi, Map, Award } from 'lucide-react';
      ...
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <nav className="flex items-center space-x-4">
          ...
          <div className="hidden md:flex items-center space-x-4 text-gray-600">
            <Compass className="w-5 h-5 hover:text-emerald-600 transition-colors" />
            <Leaf className="w-5 h-5 hover:text-emerald-600 transition-colors" />
            <Users className="w-5 h-5 hover:text-emerald-600 transition-colors" />
            <Map className="w-5 h-5 hover:text-emerald-600 transition-colors" />
            <Award className="w-5 h-5 hover:text-emerald-600 transition-colors" />
          </div>
          <LanguageSwitcher />
        </nav>
      </div>
