      ...
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-r from-green-400 via-emerald-500 to-teal-600 text-white py-20 md:py-32">
          <div className="container mx-auto px-6 text-center">
            ...
            <button 
              className="bg-white text-emerald-600 font-semibold py-3 px-8 rounded-lg shadow-lg hover:bg-gray-100 transition-colors duration-300"
        ...
        <section className="py-20 bg-emerald-600 text-white" ref={downloadSectionRef}>
          <div className="container mx-auto px-6 text-center">
