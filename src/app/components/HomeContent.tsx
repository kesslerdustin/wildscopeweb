        ...
        <section className="bg-gradient-to-r from-green-400 via-emerald-500 to-teal-600 text-white py-20 md:py-32 relative">
          ...
          >
            <div className="bg-white/60 backdrop-blur-sm p-6 rounded-lg shadow-lg inline-block mx-auto">
              ...
              <motion.button 
                className="bg-emerald-600 text-white font-semibold py-3 px-8 rounded-lg shadow-lg hover:bg-emerald-700 transition-all duration-300"
        ...
        >
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-3xl mx-auto space-y-8">
              ...
              <motion.div variants={fadeIn}>
                <h3 className="text-xl font-semibold mb-2 text-gray-800">{tFaq('question4')}</h3>
                <p className="text-gray-600">{tFaq('answer4')}</p>
              </motion.div>
              
              <motion.div variants={fadeIn}>
                <h3 className="text-xl font-semibold mb-2 text-gray-800">{tFaq('question5')}</h3>
                <p className="text-gray-600">{tFaq('answer5')}</p>
              </motion.div>
              
              <motion.div variants={fadeIn}>
                <h3 className="text-xl font-semibold mb-2 text-gray-800">{tFaq('question6')}</h3>
                <p className="text-gray-600">{tFaq('answer6')}</p>
              </motion.div>
              
              <motion.div variants={fadeIn}>
                <h3 className="text-xl font-semibold mb-2 text-gray-800">{tFaq('question7')}</h3>
